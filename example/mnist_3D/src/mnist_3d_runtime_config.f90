module mnist_3d_runtime_config
...
contains
  ...
  subroutine build_optimiser(optimiser)
    ...
    case default
       stop "Unsupported optimiser method in MNIST 3D example"
    end select
  ...
  subroutine apply_regularisation(optimiser)
    ...
    case default
       stop "Unsupported regularisation method in MNIST 3D example"
    end select
  end subroutine apply_regularisation

end module mnist_3d_runtime_config
