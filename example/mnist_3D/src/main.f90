...
program mnist_test
  ...
  real(real12), allocatable, dimension(:,:,:,:,:) :: input_spread, test_spread
...
!!!-----------------------------------------------------------------------------
  call set_global_vars(param_file="example/mnist_3D/test_job.in")
#ifdef _OPENMP
...
!!!-----------------------------------------------------------------------------
  ...
  test_spread = spread(test_images,3,1)
