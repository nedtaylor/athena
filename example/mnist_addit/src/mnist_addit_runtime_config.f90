module mnist_addit_runtime_config
...
contains
  ...
  subroutine build_optimiser(optimiser)
    ...
    case default
       stop "Unsupported optimiser method in MNIST additive example"
    end select
  ...
  subroutine apply_regularisation(optimiser)
    ...
    case default
       stop "Unsupported regularisation method in MNIST additive example"
    end select
  end subroutine apply_regularisation

end module mnist_addit_runtime_config
