module athena__batchnorm2d_layer
  ...
  type, extends(batch_layer_type) :: batchnorm2d_layer_type
   ...
   contains
     ...
     procedure, pass(this) :: print_to_unit => print_to_unit_batchnorm2d
     !! Print 2D batch normalisation layer to unit
     procedure, pass(this) :: read => read_batchnorm2d
     !! Read 2D batch normalisation layer from file

     procedure, pass(this) :: forward_derived => forward_derived_batchnorm2d
...
!###############################################################################
  subroutine print_to_unit_batchnorm2d(this, unit)
    !! Print 2D batch normalisation layer to unit
  ...
  end subroutine print_to_unit_batchnorm2d
!###############################################################################
...
!###############################################################################
  subroutine forward_derived_batchnorm2d(this, input)
    !! Forward propagation
    implicit none
  ...
  end subroutine forward_derived_batchnorm2d
!###############################################################################
