...
!###############################################################################
  module function batchnorm( &
    ...
    output%get_partial_left => get_partial_merge_batchnorm_left
    output%get_partial_right => get_partial_merge_batchnorm_right
...
!-------------------------------------------------------------------------------
  function get_partial_merge_batchnorm_left(this, upstream_grad) result(output)
    implicit none
  ...
  end function get_partial_merge_batchnorm_left
!-------------------------------------------------------------------------------
  function get_partial_merge_batchnorm_right(this, upstream_grad) result(output)
    implicit none
    class(array_type), intent(inout) :: this
    type(array_type), intent(in) :: upstream_grad
    type(array_type) :: output
  ...
  end function get_partial_merge_batchnorm_right
!###############################################################################
