...
The ``batchnorm2d_layer_type`` derived type provides a 2D batch normalization layer.
This layer applies batch normalization over 4D inputs (width, height, channels, batch), normalizing over the spatial dimensions and batch.
