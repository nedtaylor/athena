...
contains
  ...
  subroutine compare_batchnorm2d_layers(layer1, layer2, success, layer3)
     type(batchnorm2d_layer_type), intent(in) :: layer1, layer2
     logical, intent(inout) :: success
     type(batchnorm2d_layer_type), optional, intent(in) :: layer3
